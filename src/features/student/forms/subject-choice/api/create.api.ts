...
import type {
  TCreateSubjectChoiceFormErrorResponse,
...
const createSubjectChoiceForm = (data: TCreateSubjectChoiceFormRequest) => {
  return api.post<ApiResponse<TCreateSubjectChoiceFormResponse>>(
...
export const useCreateSubjectChoiceForm = (
  options?: Omit<
    UseMutationOptions<
      TCreateSubjectChoiceFormResponse,
      AxiosError<ApiResponse<TCreateSubjectChoiceFormErrorResponse>>,
  ...
  return useMutation({
    mutationKey: ['form', 'subject-choice', 'create'],
