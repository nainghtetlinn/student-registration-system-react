...
export const universityEntranceFormSchema = z.object({
...
export type TUniversityEntranceFormSchema = z.infer<
  typeof universityEntranceFormSchema
>
...
export const universityEntranceFormDefaults: TUniversityEntranceFormSchema = {
  student: {
    nameEn: '',
    nameMm: '',
    ethnicity: '',
